...
class MultistageTDCR(Tendon_Robot_Builder): 
    ...
    def _removeOldData(self): 
        ...
        os.chdir(os.path.expanduser("~/tdcr-crt/src/tendon_robots/" + self._dir_name))
    ...
    def _createIntegrator(self, stage, x, xdot, params):
        ...
        self._dir_list.append(sim.code_export_directory) # for exporting data to library folder afterwards.
    ...
    def _replaceData(self): 
        ...
        for i in range(0, len(self._dir_list)):
            ...
            os.chdir(os.path.expanduser("~/tdcr-crt/src/tendon_robots/" + self._dir_list[i]))
...
if __name__ == "__main__":
    ...
    robot_dict['mass_distribution'] = 0.3
    ...
    robot_dict = {}
    robot_dict['routing'] = transpose(SX([[0.0175, 0.0, 0], [-0.015, 0.015, 0], [-0.015, -0.015, 0], [0.015, -0.015, 0]]))
